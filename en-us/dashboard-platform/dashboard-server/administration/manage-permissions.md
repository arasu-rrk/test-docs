---
layout: post
title: Managing permissions for the users and groups in the Syncfusion Dashboard Server.
description: Learn what are all the access modes, entities & scopes we have and how to manage permissions for the users and groups in the Syncfusion Dashboard Server.
...
N> Create access can only have the scopes, All Dashboards, Dashboards in Category, All Data Sources, All Schedules and All Categories.
...
![Manage Permissions](images/Manage-permissions-user-context.png)

2. On top right corner of the user profile edit page  
![Manage Permissions](images/Manage-permissions-user-edit.png)
...
![Manage Permissions](images/manage-permissions-user.png)

Click on `Add Permission` to add permissions to the user. Add Permission dialog box is shown below.

![Add Permission](images/add-permission-user.png)
...
![Manage Permissions](images/Manage-permissions-group-context.png)
2. On top right corner of the group edit page
![Manage Permissions](images/Manage-permissions-group-edit.png)
...
![Manage Permissions](images/manage-permissions-group.png)

Click on `Add Permission` to add permissions to the group. Add Permission dialog box is shown below.

![Add Permission](images/add-permission-group.png)
